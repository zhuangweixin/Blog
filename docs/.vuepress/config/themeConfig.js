...
module.exports = {
  ...
  // bodyBgImgOpacity: 0.5, // body背景图透明度，选值 0 ~ 1.0, 默认0.5
	// bodyBgImg: 'Blog/img/jiyuanmei-15.png',  // 你的图片路径(必须位于 public 下)，可以是 URL
	bodyBgImg: 'https://s1.ax1x.com/2023/06/24/pCtVEb8.png',  // 你的图片路径(必须位于 public 下)，可以是 URL
    ...
    icons: [
      {
        ...
        title: '发邮件',
        link: 'mailto:995245717@qq.com',
      },
      {
        iconClass: 'icon-github',
        title: 'GitHub',
        link: 'https://github.com/zhuangweixin',
      },
      {
        iconClass: 'icon-erji',
        title: '听音乐',
